...
const kBackgroundColor = Color.fromRGBO(15, 20, 23, 1);
const kSearchBarColor = Color.fromRGBO(29, 40, 46, 1);
...
const cGreenColor = Color.fromARGB(255, 92, 185, 115);
const cSeaBlueColor = Color.fromARGB(255, 78, 206, 225);
const cPurpleColor = Color.fromARGB(255, 175, 92, 246);
const cOrangeColor = Color.fromARGB(255, 250, 143, 61);
...
class ColorPaletForContacts {
  static const List<Color> colorPaletContact = <Color>[
    ...
    Color.fromARGB(255, 78, 206, 225),
    Color.fromARGB(255, 175, 92, 246),
    Color.fromARGB(255, 250, 143, 61),
    Color.fromARGB(255, 255, 99, 183),
  ];
}
